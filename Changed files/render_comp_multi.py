...
from utils.traj_utils import rotation,rotation_tranport
...
def render_set_interp(model_path, name, iteration, views, gaussians1, gaussians2,pipeline, background):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        #gaussians2.o2w(view.obj_rt,view.obj_quat)
        a,b = rotation_tranport(views,idx)
        #a,b = view.obj_rt,view.obj_quat
        gaussians2.o2w_ref(a,b)
        #gaussians2.o2w_inf(a,idx)
